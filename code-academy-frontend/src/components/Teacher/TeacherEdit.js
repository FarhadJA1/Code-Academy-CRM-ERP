...
function TeacherEdit() {
    return (
        <div className='addition'>
            ...
            <div class="modal fade" id="edit-teacher" tabindex="-1" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title addition-title" id="exampleModalLabel">Edit Teacher</h5>

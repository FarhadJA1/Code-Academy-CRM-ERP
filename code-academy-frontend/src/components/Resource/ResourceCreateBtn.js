                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body row">
                            <TextField autoComplete='off' className='resource-input' onChange={(e) => props.setInput(e.target.value)} value={props.input} id="outlined-basic" label="Resource type" variant="outlined" />
                        </div>

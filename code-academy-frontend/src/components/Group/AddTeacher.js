...
function AddTeacher() {
    return (
        <div className='row addition'>
            ...
            <div className="modal fade" id="addTeacher" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        <div className="modal-header">
                            <h5 className="modal-title addition-title" id="exampleModalLabel">Add Teacher</h5>

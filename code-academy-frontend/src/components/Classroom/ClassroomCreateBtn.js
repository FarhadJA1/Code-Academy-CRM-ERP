        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-body classroom-modal-body">
              ...
              <TextField inputProps={{ inputMode: 'numeric', pattern: '[0-9]*' }} onChange={(e) => props.setCapacityInput(e.target.value)} value={props.capacityInput} className='term-input' id="outlined-basic" label="Capacity" variant="outlined" />
            </div>
            <div className="modal-footer">
              <button onClick={() => props.createHour()} data-bs-dismiss="modal" type="button" className="btn btn-outline-primary classroom-button">Save</button>

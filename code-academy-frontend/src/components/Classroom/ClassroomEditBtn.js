                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-body classroom-modal-body">
                            <TextField autoComplete='off' onChange={(e) => props.setNameInput(e.target.value)} value={props.nameInput} className='term-input' id="outlined-basic" label="Name" variant="outlined" />
                            <span className='minus'>-</span>
                            <TextField autoComplete='off' type="number" inputProps={{ inputMode: 'numeric', pattern: '[0-9]*', min: 0 }} onChange={(e) => props.setCapacityInput(e.target.value)} value={props.capacityInput} className='term-input' id="outlined-basic" label="Capacity" variant="outlined" />
                        </div>

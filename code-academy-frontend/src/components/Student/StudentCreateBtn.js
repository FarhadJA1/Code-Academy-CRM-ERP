                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body container addition">
                            ...
                            <div className="row">
                                ...
                                <div className="col-6">
                                    <TextField type='number' onChange={(e) => props.setPhoneInput(e.target.value)} value={props.phoneInput} className='student-input' id="outlined-basic" label="Phone" variant="outlined" />
                                </div>
                            </div>

...
{
    public partial class CreateCodeAcademyDb : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Student_PayType_PayTypeId",
                        column: x => x.PayTypeId,
                        principalTable: "PayType",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Student_Resource_ResourceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Student_PayTypeId",
                table: "Student",
                column: "PayTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_Student_ResourceId",
                table: "Student",
                column: "ResourceId");
        }
